...
Customer.connectSubscriptions = function (config) {
  ...
  return _connectSubscriptions.apply(this, arguments);
};
...
Customer.disconnectSubscriptions = function (config) {
  ...
  return _disconnectSubscriptions.apply(this, arguments);
};
